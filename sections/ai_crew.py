...
def ai_crew_component():
    ...
    ai_agents = [
        ...
        {
            "name": "Output Consistency (LLaMA Model 8b)",
        ...
        {
            "name": "AI-Skills Advisor (Mistral Model 12B)",
            "image": "assets/agents/AISkillsAdvisor.png",
            "description": "I'm the AI-Skills Advisor, your 24/7 assistant here to provide personalized guidance based on real-time patient feedback and recommendations from the AI clinical team. Powered by the Mistral-Nemo-Gutenberg-Doppel-12B-v2-GGUF model, I operate with 12 billion parameters and leverage an extended context window of up to 128k tokens, enabling me to capture complex nuances and deliver detailed insights.\n\nTrained on the extensive collection of Project Gutenberg and optimized for resource efficiency through GGUF quantization, I specialize in handling multilingual interactions and following detailed instructions. My goal is to help healthcare professionals enhance their performance with evidence-based insights and recommendations.\n\nI can discuss each patient feedback, suggest improvements in care, recognize key progress, and present detailed trend analyses. Additionally, I can create customized action plans and provide trend charts, all within a one-on-one interaction format where you are the focus.\n\nMy commitment is to provide comprehensive, personalized support, helping you achieve your goals and enhance each patient’s experience."
        }
